---
title: "How Threat Blocker works"
...
- **Functionality:**  
  In parallel mode the device does the following:
  - **Threat intelligence:**  
  ...
  - **Optional log mirroring:**  
    ATB can mirror logs so the Aegister Cyber Console shows your traffic events and the IP addresses our threat intelligence blocked. This gives you detailed visibility and control over security operations.
  - **Built-in VPN:**  
