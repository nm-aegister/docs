...
- Client traffic flows through Cloud Defender (the **"blue tunnel"** in the diagram), where two checks run:
  - **Threat Intelligence:** requests from sources already known for attacking other targets are refused, using a continuously updated blocklist.
...
and those trying to reach the origin while bypassing Cloud
Defender.
