...
Dopo aver effettuato l'accesso, controlla che la licenza Virtual CISO sia attivata per la tua [Organizzazione](https://app.aegister.com/organizations/). Solo in presenza di questa licenza potrai usufruire dei servizi specifici del Virtual CISO.
