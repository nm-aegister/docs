---
title: "Come funziona Threat Blocker"
...
- **Funzionalità:**  
  In questa modalità, il dispositivo svolge queste funzioni:
  ...
  - **Mirroring dei Log (Opzionale):**  
    Può effettuare il mirroring dei log: nella Aegister Cyber Console vedi gli eventi del tuo traffico e gli IP bloccati dalla nostra threat intelligence.
  - **VPN integrata:**
